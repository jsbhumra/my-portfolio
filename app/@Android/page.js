      ...
      <div className='w-full h-[100dvh] bg-transparent flex flex-col'>
        <div className='grow-0'>
          ...
          //   indicatorColor="secondary"
            ...
            sx={{ backgroundColor: currentTheme=="dark" ? '#1f2c33' : "#028069", height: '59px', marginTop: '-15px', alignItems: 'flex-end', padding: 0, border: 0, "& button.Mui-selected": { color: currentTheme=="dark" ? "#0ea783" : "#ffffff" } }}
          >
