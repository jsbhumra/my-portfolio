  ...
  return (
    <div className='w-full h-[100dvh] overflow-hidden bg-[#ffffff] dark:bg-[#000000]'>
      ...
      <div className='w-full h-[100dvh] bg-transparent flex flex-col'>
        ...
        <div id="topHeader" className='-mb-[7.5px] w-full h-[59px] bg-[rgba(247,247,247,0.3)] dark:bg-[rgba(0,0,0,0.3)] bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-70 flex justify-between items-center pl-[15px] py-0 mt-0 text-[#34B7F1] z-[110]'>
        ...
        <SwipeableViews
          ...
          <div className='pl-[17.5px] h-[45px] min-w-1/4 text-left text-[35px] text-black dark:text-white -tracking-[0.3px] font-[600]'>Updates</div>
          <Tech />
          </TabPanel>
          ...
          <div className='pl-[17.5px] h-[45px] min-w-1/4 text-left text-[35px] text-black dark:text-white -tracking-[0.3px] font-[600]'>Chats</div>
            {Chats.map((el)=>{
          ...
          <div className='pl-[17.5px] h-[45px] min-w-1/4 text-left text-[35px] text-black dark:text-white -tracking-[0.3px] font-[600]'>Profile</div>
            <Profile />
          </TabPanel>
        </SwipeableViews>
        {/* </div> */}
        <Tabs id="sliderTabs"
          ...
          //   indicatorColor="secondary"
            ...
            className='bg-white-500 backdrop-filter backdrop-blur-md bg-opacity-70'
            sx={{ display: 'flex', position: 'absolute', bottom: '-5px', width: '100%', alignItems: 'flex-start', justifyContent: 'start', height: '59px', padding: 0, paddingLeft: '3px', paddingRight: '3px', borderTop: currentTheme!="dark" && 1, borderColor: '#e8e8e8', "& button.Mui-selected": { color: currentTheme=="dark" ? "#34B7F1" : "#34B7F1" } }}
          >
            ...
            className='bg-transparent' label={currentTheme=="dark" ? " Dark Mode" : " Light Mode"} ref={ref} value={-1} sx={{ padding: 0, margin: 0, minHeight: '50px', maxHeight: '50px', minWidth: '20%', maxWidth: '20%', color: currentTheme=="dark" ? '#6b7175' : "#9d9d9d", fontWeight: 500, fontSize: '10px', textTransform: 'capitalize', lineHeight: '5px', letterSpacing: '0.5px' }} />
            ...
            className='bg-transparent' label="&nbsp;Updates" value={0} sx={{ padding: 0, margin: 0, minHeight: '50px', maxHeight: '50px', minWidth: '20%', maxWidth: '20%', color: currentTheme=="dark" ? '#6b7175' : "#9d9d9d", fontWeight: 500, fontSize: '10px', textTransform: 'capitalize', lineHeight: '5px', letterSpacing: '0.5px' }} />
            ...
            className='bg-transparent' label="&nbsp;Info" value={1} sx={{ padding: 0, margin: 0, minHeight: '50px', maxHeight: '50px', minWidth: '20%', maxWidth: '20%', color: currentTheme=="dark" ? '#6b7175' : "#9d9d9d", fontWeight: 500, fontSize: '10px', textTransform: 'capitalize', lineHeight: '5px', letterSpacing: '0.5px' }} />
            ...
            className='bg-transparent' label="&nbsp;Chats" value={2} sx={{ padding: 0, margin: 0, minHeight: '50px', maxHeight: '50px', minWidth: '20%', maxWidth: '20%', color: currentTheme=="dark" ? '#6b7175' : "#9d9d9d", fontWeight: 500, fontSize: '10px', textTransform: 'capitalize', lineHeight: '5px', letterSpacing: '0.5px' }} />
            ...
            className='bg-transparent' label="&nbsp;Profile" value={3} sx={{ padding: 0, margin: 0, minHeight: '50px', maxHeight: '50px', minWidth: '20%', maxWidth: '20%', color: currentTheme=="dark" ? '#6b7175' : "#9d9d9d", fontWeight: 500, fontSize: '10px', textTransform: 'capitalize', lineHeight: '5px', letterSpacing: '0.5px' }} />
        </Tabs>
        </div>}
    </div>
  )
