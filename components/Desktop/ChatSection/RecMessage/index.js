  ...
  return (
    <div role='row' className='group/row'>
        <div className={`relative ${last ? "mb-[12px]" : "mb-[2px]"}`}>
            <div className={`flex flex-col items-start group/message ${screenWidth>968 ? "pr-[57px] pl-[71px]" : "pr-[19px] pl-[53px]"} `}>
              <div className='relative rounded-[7.5px] grow-0 shrink-0 basis-auto text-[14.2px] leading-[19px] text-[#111b21] dark:text-[#e9edef] w-auto' style={{ maxWidth: `${currentWidth}%` }}>
                ...
                <div className='relative rounded-[7.5px] bg-white dark:bg-[#202c33]' style={{ borderTopLeftRadius: first ? '0' : '7.5px', boxShadow: '0 1px 0.5px rgba(11,20,26,.13)' }}>
