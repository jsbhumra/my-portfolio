...
export default function ChatSection({ curr, onShow, theme }) {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#efeae2] dark:bg-[#0b141a]">
        ...
        <div id="rightTop" className="relative flex items-center h-[59px] w-full py-[10px] px-[16px] bg-[#f0f2f5] dark:bg-[#202c33] z-20 border-l border-solid border-[#d1d7db] dark:border-[rgba(134,150,160,0.15)]" style={{ boxShadow:  theme=="dark" ? "0 1px 3px rgba(11,20,26,.4)" : "" }}>
            <div className="pr-[15px] -mt-[1px]" onClick={onShow}>
                <div className="w-[40px] h-[40px] rounded-full relative cursor-pointer">
                    <Image src='/jagjit.png' width={40} height={40} className="relative overflow-hidden object-center object-cover rounded-full" />
                </div>
            </div>
