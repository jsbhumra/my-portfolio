...
export default function Channel({ followed, name, image, theme }) {
  ...
  return (
    <div className='rounded-[16px] px-[8px] border border-solid border-[#e9edef] dark:border-[#233138] flex grow-0 pb-[8px] shrink items-center justify-start flex-col w-[112px] pt-[12px] hover:bg-[rgba(0,0,0,.1)] dark:hover:bg-[#1f2c33]'>
      <div role='button' className='cursor-pointer flex grow-0 shrink basis-auto min-h-[92px] min-w-0 w-[72px] items-center justify-start flex-col flex-nowrap'>
        <div className='relative'>
          <div className='absolute p-[1px] rounded-full -right-[3px] -bottom-[3px] pointer-events-none w-[20px] h-[20px] z-[250] bg-white dark:bg-[#111b21]'>
      ...
      <button className='p-[6px] border-0 bg-transparent text-[100%] cursor-pointer'>
        <div className='flex flex-row min-h-0 min-w-0 grow-0 shrink basis-auto items-center justify-start flex-nworap'>
          <div className='leading-[1.2]text-[0.875rem] font-normal' style={{ color: theme=="dark" ? followed ? '#8696a0' : '#00a884' : followed ? '#667781' : '#008069' }}>
