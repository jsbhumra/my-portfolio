...
export default function ChatSection({ curr, onShow, theme, onHide }) {
  ...
  return (
    <div className="flex flex-col w-full h-[100dvh] bg-[#efeae2] dark:bg-[#0b141a]">
        ...
        <div id="rightTop" className="relative flex items-center h-[49px] w-full py-[10px] px-[16px] bg-[#f7f7f7] dark:bg-[#202c33] z-20" style={{ boxShadow:  theme=="dark" ? "0 1px 3px rgba(11,20,26,.4)" : "" }}>
            <div className="pr-[15px] -mt-[1px] flex text-[#34B7F1] dark:text-[#aebac1]" onClick={onHide}>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="mr-[9.5px] pr-0 my-auto -ml-[10px]" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="48" d="M328 112L184 256l144 144"/></svg>
            ...
            <div className="flex flex-col grow min-w-0 justify-center cursor-pointer" onClick={onShow}>
                <div className="text-left mt-[2px] flex align-start leading-[21px] font-[900] overflow-hidden whitespace-nowrap text-[16px] text-[#000000] dark:text-[#e9edef]">
            ...
            <div className="block ml-[5px] -mr-[10px]">
                <div className="flex items-center text-[#34B7F1] dark:text-[#aebac1]">
                    <div className="ml-0 mr-[2.5px] rounded-full relative h-full flex items-center p-[8px] cursor-pointer hover:bg-[rgba(0,0,0,.1)] dark:hover:bg-[#384147]">
                    ...
                    <div className="ml-[2.5px] mr-[5px] rounded-full relative h-full flex items-center p-[8px] cursor-pointer hover:bg-[rgba(0,0,0,.1)] dark:hover:bg-[#384147]">
        ...
        <div id="rightBottom" className="relative w-full h-[49px] block z-20 flex bg-[#f7f7f7]">
            <div className="w-[11%]">
                    <div className="py-[2px] h-full flex items-center justify-center text-[#34B7F1] dark:text-[#8696a0] rounded-full">
            ...
            <div className="h-[34px] w-[56%] flex flex-row align-end rounded-full relative my-[7.5px] mx-[4px] px-[8px] py-[2px] bg-[#ffffff] dark:bg-[#202c33]">
                    <div className="absolute right-0 flex items-center justify-center text-[#34B7F1] dark:text-[#8696a0] rounded-full">
