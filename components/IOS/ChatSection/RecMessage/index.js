    ...
    <div role='row'>
        <div className={`relative ${last ? "mb-[12px]" : "mb-[2px]"}`}>
            <div className={`flex flex-col items-start ${screenWidth>968 ? "pr-[57px] pl-[71px]" : "pr-[20px] pl-[45px]"} `}>
              ...
              {last && <div className='absolute -left-[14px] text-[#ffffff] dark:text-[#202c33] -bottom-[7.5px] block rotate-[0deg] w-[40px] h-[50px]' /*style={{ textShadow: '0 1px 0.5px rgba(11,20,26,.13)' }}*/><svg viewBox="0 0 512 512" height="50" width="40" fill='currentColor' xmlns="http://www.w3.org/2000/svg"><path d="M 464 440 L 435.88 407.89 C 413.4 382.24 392.55 362.44 363.8 349.19 C 337.19 336.93 303.8 330.54 259.53 329.35 L 259.366 285.676 L 259.496 251.187 L 259.479 205.898 L 259.53 175.21 C 332.41 178.21 386.71 202.29 421.09 246.96 C 449.56 284 464 335.19 464 399.26 L 464 440 Z" style={{ transform:"matrix(0, 1, -1, 0, 512, 0.000004000000444648322)", filter: 'drop-shadow(10px -10px 5px rgba(11,20,26,.13))'}}/></svg></div>}
                ...
                <div className='relative rounded-[10px] bg-white dark:bg-[#202c33]' style={{ boxShadow: '1px 1px 0.5px rgba(11,20,26,.13)' }}>
