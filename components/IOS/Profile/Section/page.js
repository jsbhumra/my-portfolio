...
export default function Section({ title, text }) {
  return (
    <motion.div animate={{ opacity: [0,0,1], translateY: [-50,-50,0] }} transition={{ times: [0, 0.35, 1], duration: 0.8, ease: "easeInOut" }} className='px-[30px] grow-0 shrink-0 bg-white dark:bg-black basis-auto pt-[14px] pb-[15px] mb-[10px] relative z-[220]'>
        <div className='p-0 mb-[5px]'>
            <div className='flex items-center overflow-hidden text-ellipsis whitespace-nowrap relative grow shrink basis-auto'>
                <span className='leading-[1.2] text-[#34B7F1] text-[0.875rem] font-normal'>{title}</span>
            </div>
        </div>
        <div className='relative break-words text-[rgba(0,0,0,.8)] dark:text-[#d1d7db]'>
            <div className='flex relative items-start'>
                <div className='pr-[5px] mr-[20px] pt-[8px] pb-[10px] border-b dark:border-[rgba(255,255,255,0.2)] border-[rgba(0,0,0,0.2)] grow shrink basis-0 overflow-hidden leading-[20px] break-words'>
